 ...
 * @coversDefaultClass \Drupal\app_user_language_negotiation\Plugin\LanguageNegotiation\LanguageNegotiationUserAccountSaver
 */
class PluginTest extends EntityKernelTestBase {
   ...
   *
   * @var \Drupal\app_user_language_negotiation\Plugin\LanguageNegotiation\LanguageNegotiationUserAccountSaver
   */
  private $plugin;
  ...
  protected function setUp() {
    ...
    $language_manager->getCurrentLanguage()
      ->willReturn($languages['Bodo_SystemD']);
    $language_manager->getLanguage('Bodo_SystemD')
      ->willReturn($languages['Bodo_SystemD']);
  ...
  private function setPrefixes(array $languages): void {
    $config = \Drupal::configFactory()->getEditable('language.negotiation');
    foreach (array_keys($languages) as $langcode) {
      $config->set('url.prefixes.' . $langcode, $langcode);
    }
    $config->save();
  }
